...
import {
  bulkReorderServicesQuestionAnswers,
  deleteServicesQuestionAnswer,
  getServicesQuestionAnswers,
} from "@/lib/api/admin/services-forms";
import type { QuestionAnswer, ServicesFormQuestion } from "@/types/admin-api";
...
export function QuestionAnswersDialog({ open, onOpenChange, question }: QuestionAnswersDialogProps) {
  ...
  const fetchAnswers = React.useCallback(async () => {
    ...
    try {
      setIsLoading(true);
      const data = await getServicesQuestionAnswers(question.id);
  ...
  const handleDragEnd = async (event: DragEndEvent) => {
    ...
    try {
      ...
      await bulkReorderServicesQuestionAnswers(question.id, {
  ...
  const handleDelete = async (answerId: string) => {
    ...
    try {
      await deleteServicesQuestionAnswer(question.id, answerId);
