...
const schedulerReducer = (
    ...
    switch (action.type) {
        ...
        case "UPDATE_EVENT":
            console.log("UPDATE_EVENT reducer:", {
                payloadId: action.payload.id,
                payloadStartDate: action.payload.startDate,
                events: state.events.map(e => ({ id: e.id, startDate: e.startDate }))
            });
            const updatedEvents = state.events.map((event) =>
                event.id === action.payload.id ? action.payload : event
            );
            console.log("After update:", updatedEvents.map(e => ({ id: e.id, startDate: e.startDate })));
            return {
                ...state,
