...
export default function EventStyled({
    ...
    const handleDragStart = (e: React.DragEvent<HTMLDivElement>) => {
        ...
        e.dataTransfer.setData("eventData", eventDataStr);
        console.log("Drag started with event:", eventDataStr);
    };
    ...
    return (
        <div
            ...
            className={cn(
                "w-full z-50 relative border group rounded-lg flex flex-col flex-grow shadow-sm hover:shadow-md transition-shadow duration-200",
